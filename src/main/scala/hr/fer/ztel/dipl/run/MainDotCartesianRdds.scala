...
object MainDotCartesianRdds {
  ...
  def main(args : Array[String]) : Unit = {
    ...
    val customerItemMatrix : RDD[(Int, Set[Int])] = customerItemRecords.rdd
      .map {
    ...
    val recommendationMatrix = (customerItemMatrix cartesian itemItemMatrix) // cartesian is to heavy
      .map {
